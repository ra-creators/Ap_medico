  ...
  <div class="main">
    ...
    <div class="content-wrapper">
      ...
      <div class="tablebg m-4">
        <h3 class="text-center alert alert-info">Product Wholesale Detail</h3>
                ...
                if($total!=0){
                     ...
                     while($result = mysqli_fetch_assoc($data)){
                        ?><tr>
                            ...
                            <td>  <img src ="img/whoproducts/<?php echo $result['img'];?>" alt="Image" class="img-size-50 img-circle"> </td>
                            <td> <?php echo $result['price'];?> </td>
                            <td><a href="#?id=<?php echo $result['id'];?>"><i class='fas fa-pencil-alt'></i></a></td>
                            </tr> <?php
                    }
                }else{
                 ...
                 <!--
                  ...
                  <td>Otto</td>
                  <td>@mdo</td>
                  <td><img src="dist/img/avatar.png" alt="User Avatar" class="img-size-50 img-circle"></td>
