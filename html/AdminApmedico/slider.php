  ...
  <div class="main">
    ...
    <div class="content-wrapper">
      ...
      <div class="tablebg  m-4">
        <h3 class="text-center alert alert-info">Slider Image List</h3>
                ...
                if($total!=0){
                    ...
                    while($result = mysqli_fetch_array($data)){
                       ?> <tr>
                            ...
                            <td>  <img src="img/slider/<?php echo $result['img'];?>" alt="Image" class="img-size-50 img-circle" >  </td>

                            <td><a href="#.php?id=<?php echo $result['id'];?>"><i class='fas fa-pencil-alt'></i></a></td>
                            </tr> <?php 
                    }
                }else{
