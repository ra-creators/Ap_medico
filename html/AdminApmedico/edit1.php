    ...
    if(isset($_POST['submit1']))
    {
        ...
        if($fileerror === 4){
            ...
            elseif($filesize > 1000000){
                ...
                $query = "update whoproducts set skuid=$skuid,img=$newImageName where id = $id";

                mysqli_query($con,$query);
                header('location:whoprodetail.php');
            }
        }
    }
    ...
    <div class="content-wrapper">
      ...
      <div class="">
        <div class="form-group mx-5  ">
          <form action="#" method="POST" enctype="multipart/form=data" class="tablebg">
            <h5 class="alert alert-info text-center ">Product Wholesale Edit</h5>
            <div class="row ">
              <div class="col-md-5 mx-4">
                <label for="Name" class="form-label">Product Name</label>
                <input type="text" class="form-control" placeholder="Product Name" name="proname" ><br>
                <label for="">Product Image</label>
                <input type="file" name="img" id="" class="form-control" placeholder="Image" ><br>
              ...
              <div class="col-md-5 mx-4">
                ...
                <input type="number" name="price" id="" class="form-control" placeholder="Product Price" >
                 </div>
            </div>
            <div class="button-area">
              <button type="submit" value="Submit" name="submit1" id="submit1" class="btn btn-primary m-5"> Submit</button>
