<?php
    ...
    $id = $_GET['id'];
    //$img = $_POST['img'];
    $query = "update 'slider' set id=$id where id = $id";
    ...
    <div class="content-wrapper">
      ...
      <div class="popupform">
        <form action="" class="form">
          <input type="file" name="pic" id="" accept=".jpg, .jpeg,.png" required>
          <!--  <div class="button-area">
       <button type="submit" value="Submit" name="submit1" id="submit1" class="bg2-btn mt-3 submitbtn2"  onclick ="med_pre()"> Submit</button>
        
        </div> -->
          <input type="submit" value="Submit" id="submit" class="btn btn-info " onclick="sliderUpload()">
